...
export class ProducerPage {
 ...
 constructor(private network: Network, public navCtrl: NavController, private sqlite: SQLite, private toast: Toast, public navParams: NavParams, public http: Http, public authService: AuthServiceProvider) {
  ...
  synchDataToServer() {
    ...
    var myData = 
      [ { "producer_measurements" : [ {"facility_id":"1",
